...
export const Skiper67 = () => {
  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center bg-none">
      {/* <div className="absolute top-1/4 grid items-center content-start justify-center gap-6 text-center">
      ...
      >
        ...
        >
          <source src="/videos/skiper-ui-showreel.mp4" />
        </video>
      </div>
    </section>
  );
    ...
    <div className="fixed left-0 top-0 z-101 flex h-screen w-screen items-center justify-center">
      ...
      >
        <VideoPlayer style={{ width: "100%", height: "100%" }}>
          <VideoPlayerContent
            src="/videos/skiper-ui-showreel.mp4"
            autoPlay
            slot="media"
